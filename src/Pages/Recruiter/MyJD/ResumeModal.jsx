...
const ResumeModal = ({ resume, onClose }) => {
  ...
  return (
    <div className='fixed inset-0 bg-black/50 bg-opacity-40 flex items-center justify-center z-50'>
      <div className='bg-white w-full max-w-xl h-[90%] mx-auto p-6 rounded-lg shadow-lg relative animate-fadeIn overflow-y-auto'>
        <button
          onClick={onClose}
        ...
        <h2 className='text-2xl font-bold text-blue-700 mb-4'>Resume Summary</h2>
        ...
        <div className='mt-4'>
          ...
          <div className='w-full bg-gray-200 rounded-full h-4'>
            <div
              className={`h-4 rounded-full ${resume.matchPercentage >= 75
                ? 'bg-green-500'
        ...
        {/* Match Summary */}
        <div className='mt-6'>
          <p className="font-semibold text-gray-700 mb-2 text-lg">Full AI Match Summary</p>
          <pre className="whitespace-pre-wrap text-sm text-gray-700 bg-gray-50 p-4 rounded-md border border-gray-200 max-h-96 overflow-y-auto">
            {resume.matchSummary}
          </pre>
        </div>

        {/* If these fields are also provided separately, show them */}
        {resume.keyMatchingSkills?.length > 0 && (
          <div className='mt-6'>

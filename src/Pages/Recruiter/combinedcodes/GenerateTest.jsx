...
const GenerateTest = ({  onDataPass }) => {
  ...
  const jd_id = location.state?.jdId || "NA"; // Get jd_id from state or prop
  console.log('JD ID:', jd_id);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      finalFormData.jd_id = jd_id || formData.jd_id;
          ...
          <div className="bg-slate-700 px-8 py-6">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                {jd_id && (
                  <p className="text-slate-400 text-sm">Job ID: {jd_id}</p>
                )}
              </div>
            </div>
          </div>
            ...
            <div className="space-y-8">
              ...
              <div className="pt-4">
                <button
                  ...
                  disabled={loading || jobSummaryLoading || !formData.topic || !formData.num_questions || formData.num_questions < 1}
